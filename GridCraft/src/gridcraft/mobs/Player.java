...
public class Player extends Mob{
	...
	public String toString(){
		return "Health: " + getHealth() + " | " + "Damage: " + getCurrentDamage() + " | " + "Mining Strength: " + 
				getMiningStrength() + " | " + "Current Invetory: " + getInventory().getItem(getCurrentPlaceOnInv()).getClass().getSimpleName() + "\n" + getInventory().getInventoryInfo(); 
	}
